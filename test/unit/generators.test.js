...
test('search: 生成 search.json 数据', () => {
  themeConfig = {};
  const posts = [
    { title: 'Hello', path: '2024/01/01/hello/', content: 'body text', published: true, date: new Date('2024-01-01') },
    { title: 'Draft', path: '2024/01/02/draft/', content: 'secret', published: false, date: new Date('2024-01-02') }
  ];
